...
class CardStreamController {
  ...
  createCardWrapper(index) {
    ...
    const cardImages = [
      ...
      "assets/project-card.png",
      "assets/services-card.png.png",
      "assets/about-car.png",
      "assets/zb-card.png"
    ];

    const paperImages = [
      "assets/contact-paper.jpg",
      "assets/projects-paper.jpg",
      "assets/services-paper.jpg",
      "assets/about-paper.jpg",
      "assets/zb-paper.jpg"
    ];
    ...
    paperImage.className = "card-image";
    paperImage.src = paperImages[index % paperImages.length];
    paperImage.alt = "Paper";

    asciiCard.appendChild(paperImage);
